...
%%
figure;
subplot(141), imagesc(Templs.T(:,:,1)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Relief');
subplot(142), imagesc(Templs.T(:,:,2)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Relief');
subplot(143), imagesc(Templs.T(:,:,3)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Relief');
subplot(144), imagesc(Templs.T(:,:,4)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Relief');

figure;
subplot(141), imagesc(Templs.T(:,:,5)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Around Relief');
subplot(142), imagesc(Templs.T(:,:,6)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Around Relief');
subplot(143), imagesc(Templs.T(:,:,7)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Around Relief');
subplot(144), imagesc(Templs.T(:,:,8)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Around Relief');

figure;
subplot(141), imagesc(Templs.T(:,:,9)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Background');
subplot(142), imagesc(Templs.T(:,:,10)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Background');
subplot(143), imagesc(Templs.T(:,:,11)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Background');
subplot(144), imagesc(Templs.T(:,:,12)), axis image, axis xy, xlabel('\alpha'), ylabel('\beta'), title('Background');